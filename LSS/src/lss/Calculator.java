...
//        	    buff.ailment[HIT_DESTRUCTION] += 10;                //破壊命中+10
        	    ...
        	    buff.ailment[HIT_DRAGON] += 10;                     //竜語命中+10
...
//        	    buff.ailment[HIT_DESTRUCTION] += 5 + (level - 80);  //破壊命中+(level - 75)
        	    ...
        	    buff.ailment[HIT_DRAGON] += 5 + (level - 80);       //竜語命中+(level - 75)
                ...
                case R:
                    ...
                    switch (q) {
                        ...
                        case 3:
                            buff.DR += 1;                   //ダメージリダクション+1
                                                            //祝福消耗効率+5%
//                            buff.ailment[HIT_DRAGON] += 5;        //竜語命中+5
                            break;
                        case 4:
                            buff.DR += 1;                   //ダメージリダクション+1
                                                            //祝福消耗効率+5%
...
//君主魔法（プリンス・プリンセス)
        ...
        //ブレイブアバター 消費MP0/常時 STR+1 DEX+1 INT+1 MR+10% 技術耐性+2 精霊耐性+2 竜語耐性+2 恐怖耐性+2
        ...
        //グレースアバター 消費MP15/15秒 技術耐性+5 精霊耐性+5 竜語耐性+5 恐怖耐性+5 レベル80から+1ずつ増加(最大+10)
        if (ui.cb_buff[P_GA].isSelected()) {
            switch ((String) ui.cb_buff_group[P_GA].getSelectedItem()) {
                case "君主L80":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+5 精霊耐性+5 竜語耐性+5 恐怖耐性+5");
                    buff.ailment[STUN] += 5;
                    ...
                    break;
                case "君主L81":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+6 精霊耐性+6 竜語耐性+6 恐怖耐性+6");
                    buff.ailment[STUN] += 6;
                    ...
                    break;
                case "君主L82":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+7 精霊耐性+7 竜語耐性+7 恐怖耐性+7");
                    buff.ailment[STUN] += 7;
                    ...
                    break;
                case "君主L83":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+8 精霊耐性+8 竜語耐性+8 恐怖耐性+8");
                    buff.ailment[STUN] += 8;
                    ...
                    break;
                case "君主L84":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+9 精霊耐性+9 竜語耐性+9 恐怖耐性+9");
                    buff.ailment[STUN] += 9;
                    ...
                    break;
                case "君主L85+":
                    ui.cb_buff[P_GA].setToolTipText("技術耐性+10 精霊耐性+10 竜語耐性+10 恐怖耐性+10");
                    buff.ailment[STUN] += 10;
...
//        }
        ...
        if (buki.op.ailment[HIT_DRAGON] + buki.op2.ailment[HIT_DRAGON] > 0) {
            buki_text += " 竜語命中+" + (buki.op.ailment[HIT_DRAGON] + buki.op2.ailment[HIT_DRAGON]);
        }
        if (buki.op.ailment[HIT_TERROR] + buki.op2.ailment[HIT_TERROR] > 0) {
            buki_text += " 恐怖命中+" + (buki.op.ailment[HIT_TERROR] + buki.op2.ailment[HIT_TERROR]);
        }
